...
\begin{thebibliography}{1}
  ...
  \bibitem{async-servers} Benjamin Erb, \emph{Concurrent Programming for Scalable Web Architectures}, \url{http://berb.github.io/diploma-thesis/original/042_serverarch.html} [Data uzyskania dostępu: 8 styczeń 2014]
  ...
  \bibitem{varnish-cache} Tollef Fog Heen, Kristian Lyngstøl, Jérôme Renard, \emph{The Varnish Book}, \url{https://www.varnish-software.com/static/book/HTTP.html} [Data uzyskania dostępu: 8 styczeń 2014]
  ...
  \bibitem{haproxy-conf} \emph{HAProxy Configuration Manual}, http://haproxy.1wt.eu/download/1.3/doc/configuration.txt [Data uzyskania dostępu: 3 styczeń 2014]
...
\newpage
\addcontentsline{toc}{section}{Spis tabel i rysunków}
\listoftables
