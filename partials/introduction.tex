...
Pan Piotr Pelczar odpowiedzialny był za pracę nad zaprojektowaniem ogólnej architektury systemu, napisaniem pilotów sterujących oraz serwerów, do których łączą się piloty. Napisana została również przykładowa gra PONG oraz przeprowadzona została również dywagacja na temat możliwości rozproszenia systemu. Przeprowadził konfigurację CDN za pomocą Varnish Cache.
