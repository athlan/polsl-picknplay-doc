...
\hspace*{\fill} \\
	...
	\begin{tabular}{|c|c|c|}
	\hline
	\textbf{Start} & \textbf{rozmiar} & \textbf{użycie} \hspace*{\fill} \\ 
	\hline
	0 & 8KB & Nieużywane, dostępne do układu partycji \hspace*{\fill} \\
	\hline
	8 & 24KB & SPL \footnote{ang. emph{Secondary Program Loader}} \hspace*{\fill} \\
	\hline
	32 & 512KB & u-boot \hspace*{\fill} \\
	\hline
	544 & 128KB & Środowisko \hspace*{\fill} \\
	\hline
	672 & 352KB & Zarezerwowana \hspace*{\fill} \\
	\hline
	1024 & - & Dostępne dla partycji \hspace*{\fill} \\
	\hline
...
Kod źródłowy serwera znajduję się w załączniku ~\ref{app:server_c}, jest on wspólny dla wszystkich platform unixowych.		
	\item[generator zdarzeń wejścia] \h\fill \hspace*{\fill} \\ 
		...
		\begin{lstlisting}[language=bash]
		"xdpyinfo -display :0 | sed 's/^ *dimensions: *\hspace*{\fill} \\([0-9x]*\hspace*{\fill} \\).*/\hspace*{\fill} \\1/;t;d'";
		\end{lstlisting}
	...
	\item[serwer X] \h\fill \hspace*{\fill} \\
